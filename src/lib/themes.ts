...
export const COUPLE_POSES: PosePrompt[] = [
  ...
  { id: 3, title: "Cool Back-to-Back 😎", subtitle: "Cross arms and look like movie stars", emoji: "🕶️" },
  { id: 4, title: "Funny Faces! 😜", subtitle: "Cross eyes, stick tongue out, make each other laugh", emoji: "🤪" },
  { id: 5, title: "Warm Bear Hug 👩‍❤️‍👨", subtitle: "Wrap arms around each other tight", emoji: "🤗" },
  { id: 6, title: "Eye Contact Whisper 👀", subtitle: "Look into each other's eyes and smile", emoji: "😍" },
];
...
export const THEMES: Record<string, Theme> = {
  korean_pastel: {
    ...
    frameColors: ["#ffffff", "#ffe4e6", "#f3e8ff", "#dbeafe", "#fef3c7", "#18181b"],
    framePatterns: [
  ...
  vintage_romance: {
    ...
    frameColors: ["#fefcbf", "#f5f5f4", "#e7e5e4", "#78350f", "#1c1917"],
    framePatterns: [
      { id: "solid", name: "Classic Paper" },
      { id: "filmstrip", name: "Film Border 🎞️" },
      { id: "newspaper", name: "Vintage Script 📜" },
    ],
  ...
  cyber_romance: {
    ...
    frameColors: ["#0f172a", "#1e1b4b", "#311042", "#022c22", "#450a0a", "#ffffff"],
    framePatterns: [
      { id: "solid", name: "Deep Dark" },
      { id: "neon_grid", name: "Neon Grid 🌐" },
      { id: "cyber_scan", name: "Cyber Scan ⚡" },
    ],
    fontClass: "font-mono",
  ...
  floral_garden: {
    ...
    frameColors: ["#fff1f2", "#fdf2f8", "#ecfdf5", "#fef8f6", "#ffffff", "#27272a"],
    framePatterns: [
      { id: "solid", name: "Silk White" },
      { id: "floral_vines", name: "Rose Vines 🌿" },
      { id: "rose_petals", name: "Rose Petals 🌺" },
    ],
    fontClass: "font-serif",
  ...
  y2k_retro: {
    ...
    frameColors: ["#ffffff", "#f0abfc", "#38bdf8", "#fde047", "#4ade80", "#000000"],
    framePatterns: [
      { id: "solid", name: "Pop Solid" },
      { id: "pixels", name: "Pixel Hearts 👾" },
